...
> If you are using [Bindhosts](https://github.com/bindhosts/bindhosts), select Mode 8 (ksu_susfs_overlay) in the module settings. Otherwise, any application will be able to **SEE** your modified hosts file.
